...
4. Specify schedule details to run dataset:
   ...
   * **Repeat** (e.g., daily, weekly, ...), **Every**.
   ![Create Export Schedule](./images/analytics-cloud-data-connection-schedule-details.png)
...
3. Select **Jobs**.
   ![Scheduled Export Enabled](./images/analytics-cloud-data-jobs.png)
4. Select **Schedules** and localize your schedule.
5. Go to actions menu and click **Inspect**.
   ![Scheduled Export Enabled](./images/analytics-cloud-data-jobs-schedules-inspect.png)
6. On left side select **History** and check the status of the runs.
   ![Scheduled Export Enabled](./images/analytics-cloud-data-jobs-schedule-history.png)
